...
import type { Eventplanung, EinladungenRsvp, Gaesteverzeichnis, Dienstleisterbuchungen, Dienstleisterverzeichnis, Schnelleinladung, CreateEventplanung, CreateEinladungenRsvp, CreateGaesteverzeichnis, CreateDienstleisterbuchungen, CreateDienstleisterverzeichnis, CreateSchnelleinladung } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async createEventplanungEntry(fields: CreateEventplanung) {
    return callApi('POST', `/apps/${APP_IDS.EVENTPLANUNG}/records`, { fields: cleanFieldsForApi(fields as any, 'eventplanung') });
  }
  static async updateEventplanungEntry(id: string, fields: Partial<CreateEventplanung>) {
    return callApi('PATCH', `/apps/${APP_IDS.EVENTPLANUNG}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'eventplanung') });
  }
  ...
  static async getEinladungenRsvp(): Promise<EinladungenRsvp[]> {
    ...
    return enrichLookupFields(records, 'einladungen_rsvp');
  }
  static async getEinladungenRsvpEntry(id: string): Promise<EinladungenRsvp | undefined> {
    ...
    return enrichLookupFields([record], 'einladungen_rsvp')[0];
  }
  static async createEinladungenRsvpEntry(fields: CreateEinladungenRsvp) {
    return callApi('POST', `/apps/${APP_IDS.EINLADUNGEN_RSVP}/records`, { fields: cleanFieldsForApi(fields as any, 'einladungen_rsvp') });
  }
  static async updateEinladungenRsvpEntry(id: string, fields: Partial<CreateEinladungenRsvp>) {
    return callApi('PATCH', `/apps/${APP_IDS.EINLADUNGEN_RSVP}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'einladungen_rsvp') });
  }
  ...
  static async createGaesteverzeichni(fields: CreateGaesteverzeichnis) {
    return callApi('POST', `/apps/${APP_IDS.GAESTEVERZEICHNIS}/records`, { fields: cleanFieldsForApi(fields as any, 'gaesteverzeichnis') });
  }
  static async updateGaesteverzeichni(id: string, fields: Partial<CreateGaesteverzeichnis>) {
    return callApi('PATCH', `/apps/${APP_IDS.GAESTEVERZEICHNIS}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'gaesteverzeichnis') });
  }
  ...
  static async createDienstleisterbuchungenEntry(fields: CreateDienstleisterbuchungen) {
    return callApi('POST', `/apps/${APP_IDS.DIENSTLEISTERBUCHUNGEN}/records`, { fields: cleanFieldsForApi(fields as any, 'dienstleisterbuchungen') });
  }
  static async updateDienstleisterbuchungenEntry(id: string, fields: Partial<CreateDienstleisterbuchungen>) {
    return callApi('PATCH', `/apps/${APP_IDS.DIENSTLEISTERBUCHUNGEN}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'dienstleisterbuchungen') });
  }
  ...
  static async createDienstleisterverzeichni(fields: CreateDienstleisterverzeichnis) {
    return callApi('POST', `/apps/${APP_IDS.DIENSTLEISTERVERZEICHNIS}/records`, { fields: cleanFieldsForApi(fields as any, 'dienstleisterverzeichnis') });
  }
  static async updateDienstleisterverzeichni(id: string, fields: Partial<CreateDienstleisterverzeichnis>) {
    return callApi('PATCH', `/apps/${APP_IDS.DIENSTLEISTERVERZEICHNIS}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'dienstleisterverzeichnis') });
  }
