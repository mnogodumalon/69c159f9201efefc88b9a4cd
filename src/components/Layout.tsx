...
import { IconArrowBackUp, IconCalendar, IconCalendarCheck, IconFileText, IconLayoutDashboard, IconMenu2, IconSettings } from '@tabler/icons-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c159d0fc8e176dbef4c8b9?template=list_page"
