...
interface DienstleisterverzeichnisDialogProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (fields: Dienstleisterverzeichnis['fields']) => Promise<void>;
  defaultValues?: Dienstleisterverzeichnis['fields'];
  enablePhotoScan?: boolean;
  enablePhotoLocation?: boolean;
}

export function DienstleisterverzeichnisDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: DienstleisterverzeichnisDialogProps) {
  const [fields, setFields] = useState<Partial<Dienstleisterverzeichnis['fields']>>({});
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'dienstleisterverzeichnis');
      await onSubmit(clean as Dienstleisterverzeichnis['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      const schema = `{\n  "dl_firmenname": string | null, // Firmenname\n  "dl_ansprechpartner_vorname": string | null, // Ansprechpartner Vorname\n  "dl_ansprechpartner_nachname": string | null, // Ansprechpartner Nachname\n  "dl_email": string | null, // E-Mail-Adresse\n  "dl_telefon": string | null, // Telefonnummer\n  "dl_kategorie": LookupValue | null, // Kategorie (select one key: "catering" | "technik" | "location" | "musik" | "fotografie" | "dekoration" | "transport" | "sonstiges") mapping: catering=Catering, technik=Technik / AV, location=Location, musik=Musik / Entertainment, fotografie=Fotografie / Video, dekoration=Dekoration, transport=Transport, sonstiges=Sonstiges\n  "dl_website": string | null, // Website\n  "dl_notizen": string | null, // Notizen\n}`;
      ...
      setFields(prev => {
        ...
        return merged as Partial<Dienstleisterverzeichnis['fields']>;
      });
      setScanSuccess(true);
  ...
  const DIALOG_INTENT = defaultValues ? 'Dienstleisterverzeichnis bearbeiten' : 'Dienstleisterverzeichnis hinzufügen';
    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="dl_ansprechpartner_vorname">Ansprechpartner Vorname</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="dl_ansprechpartner_nachname">Ansprechpartner Nachname</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="dl_email">E-Mail-Adresse</Label>
            <Input
              id="dl_email"
              type="email"
          ...
          <div className="space-y-2">
            <Label htmlFor="dl_telefon">Telefonnummer</Label>
            <Input
              id="dl_telefon"
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="technik">Technik / AV</SelectItem>
                <SelectItem value="location">Location</SelectItem>
                <SelectItem value="musik">Musik / Entertainment</SelectItem>
                <SelectItem value="fotografie">Fotografie / Video</SelectItem>
